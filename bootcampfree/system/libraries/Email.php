...
class CI_Email {
	...
	var	$protocol		= "localhost";	// mail/sendmail/smtp
	var	$smtp_host		= "http://localhost:83";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "info@localhost";		// SMTP Username
	var	$smtp_pass		= "info";		// SMTP Password
